...
class CameraFrameExtractor: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    private func configureSession() {
        ...
        videoOutput.setSampleBufferDelegate(self, queue: DispatchQueue(label: "CameraFrameExtractor sample buffer"))
